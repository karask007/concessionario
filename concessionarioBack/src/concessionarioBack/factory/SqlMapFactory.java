package concessionarioBack.factory;
...
public class SqlMapFactory {
	...
	private final String resource = "datasource.xml"; // esempio di dependency injection ovvero questa classe dipende dal datasource ,non puo funzionare sennò
